...
PROTOBUF_CONSTEXPR Infomation::Infomation(
...
struct InfomationDefaultTypeInternal {
  PROTOBUF_CONSTEXPR InfomationDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~InfomationDefaultTypeInternal() {}
  union {
    Infomation _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 InfomationDefaultTypeInternal _Infomation_default_instance_;
...
const uint32_t TableStruct_infomation_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Infomation, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Infomation, _impl_.username_),
  PROTOBUF_FIELD_OFFSET(::Infomation, _impl_.roomname_),
  PROTOBUF_FIELD_OFFSET(::Infomation, _impl_.data1_),
  PROTOBUF_FIELD_OFFSET(::Infomation, _impl_.data2_),
  PROTOBUF_FIELD_OFFSET(::Infomation, _impl_.data3_),
  PROTOBUF_FIELD_OFFSET(::Infomation, _impl_.reqcode_),
  PROTOBUF_FIELD_OFFSET(::Infomation, _impl_.rescode_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Infomation)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::_Infomation_default_instance_._instance,
};

const char descriptor_table_protodef_infomation_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020infomation.proto\"\233\001\n\nInfomation\022\020\n\010use"
  "rName\030\001 \001(\t\022\020\n\010roomName\030\002 \001(\t\022\r\n\005data1\030\003"
  " \001(\t\022\r\n\005data2\030\004 \001(\t\022\r\n\005data3\030\005 \001(\t\022\035\n\007re"
  "qCode\030\006 \001(\0162\014.RequestCode\022\035\n\007resCode\030\007 \001"
  "(\0162\014.RespondCode*\273\001\n\013RequestCode\022\r\n\tUser"
...
const ::_pbi::DescriptorTable descriptor_table_infomation_2eproto = {
    false, false, 584, descriptor_table_protodef_infomation_2eproto,
    "infomation.proto",
...
class Infomation::_Internal {
 public:
};

Infomation::Infomation(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Infomation)
}
Infomation::Infomation(const Infomation& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  Infomation* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:Infomation)
}

inline void Infomation::SharedCtor(
...
Infomation::~Infomation() {
  // @@protoc_insertion_point(destructor:Infomation)
...
inline void Infomation::SharedDtor() {
...
void Infomation::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void Infomation::Clear() {
// @@protoc_insertion_point(message_clear_start:Infomation)
...
const char* Infomation::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Infomation.userName"));
        } else
          goto handle_unusual;
        continue;
      // string roomName = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Infomation.roomName"));
        } else
          goto handle_unusual;
        continue;
      // string data1 = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Infomation.data1"));
        } else
          goto handle_unusual;
        continue;
      // string data2 = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Infomation.data2"));
        } else
          goto handle_unusual;
        continue;
      // string data3 = 5;
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Infomation.data3"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Infomation::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Infomation)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Infomation)
  return target;
}

size_t Infomation::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Infomation)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData Infomation::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    Infomation::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*Infomation::GetClassData() const { return &_class_data_; }


void Infomation::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<Infomation*>(&to_msg);
  auto& from = static_cast<const Infomation&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Infomation)
...
void Infomation::CopyFrom(const Infomation& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Infomation)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Infomation::IsInitialized() const {
  return true;
}

void Infomation::InternalSwap(Infomation* other) {
  using std::swap;
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Infomation, _impl_.rescode_)
      + sizeof(Infomation::_impl_.rescode_)
      - PROTOBUF_FIELD_OFFSET(Infomation, _impl_.reqcode_)>(
          reinterpret_cast<char*>(&_impl_.reqcode_),
          reinterpret_cast<char*>(&other->_impl_.reqcode_));
}

::PROTOBUF_NAMESPACE_ID::Metadata Infomation::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::Infomation*
Arena::CreateMaybeMessage< ::Infomation >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Infomation >(arena);
}
